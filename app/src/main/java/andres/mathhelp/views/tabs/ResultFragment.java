...
import andres.mathhelp.data.ResultFinal;
...
public class ResultFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        final RadioGroup radioGroup = (RadioGroup) view.findViewById(R.id.resultRg);
    ...
    private void showDialog(String answer){
        ...
        alertDialog.setMessage(new ResultFinal(answer).ResultFinal());
